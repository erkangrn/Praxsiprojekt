...
In der zweiten Phase wird eine In-Order-Traversierung über dem Baum ausgeführt. Da diese vorgibt, erst den linken Teilbaum, dann den Knoten
...
Sollte ein Knoten nun links von seinem linken Sohn bzw. rechts von seinem rechten Sohn stehen, dann wird der Knoten so verschoben, dass dieser
rechts von seinem linken Sohn bzw. links von seinem rechten Sohn steht. Dadurch wird garantiert, dass jedes linke Kind links
