...
Diese Klasse erbt von der, in der Abbildung \ref{code:knotenclass} gezeigten, Knoten-Klasse. In dieser Klasse wurden
...
in dem die einzelnen Knoten in der geforderten Reihenfolge übergeben werden. In dem übergeben Consumer 
...
wird. Hierfür eine Hilfsvariable namens 'current' deklariert, die immer den derzeitigen Knoten beinhaltet. 
Die Implementierung entspricht dem zuvor gezeigten \nameref{chap:kapitel3_2_Ablauf}. 
