...
sondern es werden zwei Subtrees unabhängig voneinander platziert und dann so nah wie möglich aneinander geschoben \cite[]{q2}. 
...
Zu Beginn der Prozedur wird geprüft, ob der übergebene Knoten \ac{NULL} ist. Wenn dies nicht der Fall ist, 
...
ausgeführt, bis einer der beiden Zeiger (auf linkes/rechtes Kind) gleich \ac{NULL} ist. Diese Schleife sorgt dafür, dass entlang der rechten 
...
Nach dieser Schleife wird der Offset des aktuellen Knotens auf die Hälfte des Abstandes zwischen den Söhnen plus eins gesetzt. 
...
initiale X-Position (ist beliebig). Dann prüft die Prozedur, ob der Knoten ungleich \ac{NULL} ist. Wenn dies der Fall ist, dann wird geschaut, 
